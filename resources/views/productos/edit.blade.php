...
<div class="row">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
        ...
        <div class="card-body">
            <form id="formularioCrearProducto" class="form-control" action="/{{ $user->username }}/gimnasios/{{ $gimnasio->nombre }}/productos/{{ $producto->id }}/edit" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <button id="botonCrearProducto" type="submit" class="btn btn-primary btn-lg btn-block" data-toggle="tooltip" data-placement="top" title="Actualizar">Actualizar</button>
            </form>
        </div>
        </div>
    </div>
